...
public class TinhGiaBan {
    ...
    public TinhGiaBan(String ten, String donvitinh,double dongia, double soluong) {
        ...
        this.mahang = "MH" + tmp;
        this.phivanchuyen =  (dongia*soluong)*5/100;
    ...
    public String toString() {
        return this.mahang + " " + this.ten + "  "+ this.donvitinh + " "+ Math.round(this.phivanchuyen) + " "+ Math.round(this.thanhtien) + " "+ Math.round(this.giaban);
    }
}
